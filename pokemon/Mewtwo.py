...
class Mewtwo (my_sprite):
  ...
  def draw_front(self): # {{{
    ...
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 14*self.size,  self.my_y + 48*self.size,  1*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 18*self.size,  self.my_y + 48*self.size,  3*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 21*self.size,  self.my_y + 48*self.size,  1*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 22*self.size,  self.my_y + 48*self.size,  3*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 25*self.size,  self.my_y + 48*self.size,  2*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_1, [self.my_x + 27*self.size,  self.my_y + 48*self.size,  2*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 29*self.size,  self.my_y + 48*self.size,  2*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_1, [self.my_x + 31*self.size,  self.my_y + 48*self.size,  1*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 32*self.size,  self.my_y + 48*self.size,  3*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 35*self.size,  self.my_y + 48*self.size,  3*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 41*self.size,  self.my_y + 48*self.size,  1*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 42*self.size,  self.my_y + 48*self.size,  3*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 45*self.size,  self.my_y + 48*self.size,  1*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 15*self.size,  self.my_y + 49*self.size,  3*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 18*self.size,  self.my_y + 49*self.size,  2*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 20*self.size,  self.my_y + 49*self.size,  2*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 22*self.size,  self.my_y + 49*self.size,  2*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 24*self.size,  self.my_y + 49*self.size,  2*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_1, [self.my_x + 26*self.size,  self.my_y + 49*self.size,  3*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 34*self.size,  self.my_y + 49*self.size,  4*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 38*self.size,  self.my_y + 49*self.size,  1*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_1, [self.my_x + 39*self.size,  self.my_y + 49*self.size,  1*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 40*self.size,  self.my_y + 49*self.size,  1*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 41*self.size,  self.my_y + 49*self.size,  6*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 17*self.size,  self.my_y + 50*self.size,  7*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 30*self.size,  self.my_y + 50*self.size,  3*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 36*self.size,  self.my_y + 50*self.size,  1*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 41*self.size,  self.my_y + 50*self.size,  8*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_1, [self.my_x + 18*self.size,  self.my_y + 51*self.size,  4*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 22*self.size,  self.my_y + 51*self.size,  4*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 26*self.size,  self.my_y + 51*self.size,  2*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_1, [self.my_x + 28*self.size,  self.my_y + 51*self.size,  2*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 30*self.size,  self.my_y + 51*self.size,  4*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 41*self.size,  self.my_y + 51*self.size,  1*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_1, [self.my_x + 42*self.size,  self.my_y + 51*self.size,  2*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 44*self.size,  self.my_y + 51*self.size,  1*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 45*self.size,  self.my_y + 51*self.size,  6*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 16*self.size,  self.my_y + 52*self.size,  2*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_1, [self.my_x + 18*self.size,  self.my_y + 52*self.size,  1*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 19*self.size,  self.my_y + 52*self.size,  7*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 26*self.size,  self.my_y + 52*self.size,  4*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_1, [self.my_x + 30*self.size,  self.my_y + 52*self.size,  3*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 33*self.size,  self.my_y + 52*self.size,  3*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 42*self.size,  self.my_y + 52*self.size,  2*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 46*self.size,  self.my_y + 52*self.size,  6*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 16*self.size,  self.my_y + 53*self.size,  2*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 18*self.size,  self.my_y + 53*self.size,  1*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 19*self.size,  self.my_y + 53*self.size,  5*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 24*self.size,  self.my_y + 53*self.size,  4*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_1, [self.my_x + 28*self.size,  self.my_y + 53*self.size,  1*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 29*self.size,  self.my_y + 53*self.size,  4*self.size, 1*self.size])
    ...
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 46*self.size,  self.my_y + 53*self.size,  2*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_2, [self.my_x + 48*self.size,  self.my_y + 53*self.size,  3*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 51*self.size,  self.my_y + 53*self.size,  1*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 52*self.size,  self.my_y + 53*self.size,  1*self.size, 1*self.size])
    # }}}
    ### 54 ### {{{
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 16*self.size,  self.my_y + 54*self.size,  3*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 19*self.size,  self.my_y + 54*self.size,  4*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_1, [self.my_x + 23*self.size,  self.my_y + 54*self.size,  1*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 24*self.size,  self.my_y + 54*self.size,  4*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 41*self.size,  self.my_y + 54*self.size,  1*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 42*self.size,  self.my_y + 54*self.size,  3*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 45*self.size,  self.my_y + 54*self.size,  3*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_0, [self.my_x + 48*self.size,  self.my_y + 54*self.size,  3*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 51*self.size,  self.my_y + 54*self.size,  1*self.size, 1*self.size])
    # }}}
    ### 55 ### {{{
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 19*self.size,  self.my_y + 55*self.size,  4*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 42*self.size,  self.my_y + 55*self.size,  3*self.size, 1*self.size])
    pygame.draw.rect(self.screen, self.color_3, [self.my_x + 48*self.size,  self.my_y + 55*self.size,  3*self.size, 1*self.size])
    # }}} }}}
